...
xhr.open("POST", "https://adm.pre.cloudportal.telefonicatech.com/WS/v2/api/AUTO_flujos_ejecuciones");
xhr.setRequestHeader("Content-Type", "application/json");
xhr.setRequestHeader("TokenAuth", "7362c009-7aec-46fe-a88c-2e60191ca318");
